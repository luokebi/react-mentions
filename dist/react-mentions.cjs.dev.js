...
function (_Component) {
  ...
  function SuggestionsOverlay() {
    ...
    _defineProperty(_assertThisInitialized(_this), "enableMouse", function () {
      if (_this.ulElement && _this.ulElement.style.pointerEvents === 'none') {
        _this.ulElement.style.pointerEvents = 'auto';
      }
    });
  ...
  _createClass(SuggestionsOverlay, [{
    ...
    value: function componentDidUpdate() {
      ...
      return; // const scrollTop = this.ulElement.scrollTop
...
var makeTriggerRegex = function makeTriggerRegex(trigger) {
  ...
  if (trigger instanceof RegExp) {
    ...
    return new RegExp("(?:^|[^a-z|A-Z|0-9|-|&|%|$|!|)|\\]|~|*|+|\\^])(".concat(escapedTriggerChar, "([^").concat(allowSpaceInQuery ? '' : '\\s').concat(escapedTriggerChar, "]*))$")); // return new RegExp(

...
var SuggestionsOverlay = function(_Component) {
  function SuggestionsOverlay() {
    ...
    _defineProperty(_assertThisInitialized(_this), "enableMouse", function() {
      _this.ulElement && "none" === _this.ulElement.style.pointerEvents && (_this.ulElement.style.pointerEvents = "auto");
  ...
  return _inherits(SuggestionsOverlay, _Component), _createClass(SuggestionsOverlay, [ {
    key: "componentDidUpdate",
    value: function() {
      !this.ulElement || this.ulElement.offsetHeight >= this.ulElement.scrollHeight || !this.props.scrollFocusedIntoView || (this.ulElement.style.pointerEvents = "none", 
...
var makeTriggerRegex = function(trigger) {
  ...
  return new RegExp("(?:^|[^a-z|A-Z|0-9|-|&|%|$|!|)|\\]|~|*|+|\\^])(".concat(escapedTriggerChar, "([^").concat(allowSpaceInQuery ? "" : "\\s").concat(escapedTriggerChar, "]*))$"));
